...
export const metadata: Metadata = {
  title: "Reza Asadi | Computer Engineer",
  description:
    "Portfolio of Reza Asadi, Computer Engineer specializing in Machine Learning, Computer Vision, NLP, and Data Science.",
  authors: [{ name: "Reza Asadi" }],
  keywords: ["Computer Engineer", "Machine Learning", "Computer Vision", "NLP", "Data Science", "Python", "Portfolio"],
    generator: 'v0.app'
}
